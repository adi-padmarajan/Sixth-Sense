...
// silent at MAX_RANGE_MM and beyond. TODO: tune once tested on skin --
// these are first-guess values, not measured for comfort.
...
static double hz_for_distance(int distance_mm) {
    ...
    return MAX_HZ * (1.0 - distance_mm / MAX_RANGE_MM);
}
